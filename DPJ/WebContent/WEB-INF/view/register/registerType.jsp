...
<link href="/DPJ/css/register/registerType.css" rel="stylesheet" />
...
<script type="text/javascript" src="/DPJ/js/util/ejyooMyutils.js"></script>
<script type="text/javascript" src="/DPJ/js/register/register.js"></script>
</head>
