                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <form id="fm" method="post" enctype="multipart/form-data">
	                        <input type="hidden" value="<%=eventVO.getBoardSeq() %>">
	                        <input type="hidden" value="<%=eventVO.getUserId() %>">
							<div class="input-group mb-3 col-md-10">
							  <span class="input-group-text" id="basic-addon3">제목</span>
							  <input type="text" class="form-control" id="boardTitle" aria-describedby="basic-addon3" readonly="readonly" value="<%=eventVO.getBoardTitle() %>">
							</div>
							
							<div class="input-group mb-3 col-md-10">
							  <span class="input-group-text">내용</span>
							  <textarea class="form-control" id="boardContent" aria-label="With textarea" rows="10" readonly="readonly"><%=eventVO.getBoardContent() %></textarea>
							</div>
