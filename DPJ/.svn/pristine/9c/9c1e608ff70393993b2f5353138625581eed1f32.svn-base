	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h1 class="my-4">
					통합 커뮤니티 게시판 <small>[개발, 취업, 잡담, 반별]</small>
				</h1>
		...
		%>
								...
								<tr>
									...
									<td><a
										href="select.do?memId=<%=boardList.get(i).getUserId()%>"><%=boardList.get(i).getUserId() %></a></td>
						...
						<div class="row">
							<div class="col-lg-6">
								<ul class="list-unstyled mb-0">
									<li><a class="text-info" href="#">통합 커뮤니티 게시판</a></li>
									<li><a class="text-info" href="#">개발 커뮤니티</a></li>
							...
							<div class="col-lg-6">
								<ul class="list-unstyled mb-0">
									<li><span class="text-info" href="#">반별 커뮤니티</span></li>
